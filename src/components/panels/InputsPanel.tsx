  ...
  return (
    <div className="space-y-4 p-4">
      <div className="flex flex-wrap gap-2">
        <Button size="sm" className="button-red" onClick={randomize}>
          <Shuffle className="mr-1 h-3.5 w-3.5" /> {t("randomize")}
        </Button>
        <Button size="sm" className="button-red" onClick={() => setAll(0)}>
          <RotateCcw className="mr-1 h-3.5 w-3.5" /> {t("all0")}
        </Button>
        <Button size="sm" className="button-red" onClick={() => setAll(1)}>
